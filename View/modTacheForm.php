...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>Nouvelle tache</h3></header>
				...
				<div class="module_content">
						<fieldset>
						<?php getTache($_GET['id']);?>
							<label>Date : </label>
							<input type="date" size="50%" id="selectedDate" value="<?php echo $_SESSION['td'];?>"/>
						</fieldset>
						<fieldset>
							<label>Tache : </label>
							<textarea rows="12" name="contenu" id="contenu"><?php echo $_SESSION['tcontenu'];?></textarea>
						</fieldset>
			...
			<footer>
				<div class="submit_link">
					...
					<input type="submit" value="Modifier" class="alt_btn" onclick="addTache()">
	...
	<form style="display: hidden" method="post" action="../Controlor/MainControlor.php?fun=modTache2" id="newFormTache">
		<input type="text" id="oldId" name="oldId" value="<?php echo $_SESSION['tid'];?>" >
